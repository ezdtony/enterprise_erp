                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="./index.html" class="text-nowrap logo-img text-center d-block py-3 w-100">
                                    <img src="assets/images/logos/logo_astelecom.png" width="180" alt="">
                                </a>
                                <p class="text-center">Servimos para comunicarte</p>
                                ...
                                <form id="loginForm">
                                    ...
                                    <!-- <div class="d-flex align-items-center justify-content-between mb-4">
                                        ...
                                        <a class="text-primary fw-bold" href="./forgot-password.html">¿Olvidaste la contraseña ?</a>
                                    </div> -->
