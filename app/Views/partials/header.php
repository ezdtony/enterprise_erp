            ...
            <div>
                <div class="brand-logo d-flex align-items-center justify-content-between">
                    <a href="<?= BASE_URL ?>home" class="text-nowrap logo-img">
                        <img src="<?= BASE_URL ?>assets/images/logos/dark-logo.svg" width="160" alt="Enterprise ERP" />
                    </a>
                ...
                <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
                    <ul id="sidebarnav" class="pt-3">
                        ...
                        <?php foreach ($modules as $mod): ?>
                            ...
                            <li class="sidebar-item">
                                ...
                                <?php if ($hasChildren): ?>
                                    ...
                                    <ul class="collapse first-level base-level-line">
                                        ...
                                        <?php foreach ($children as $sub): ?>
                                            <li class="sidebar-item">
                                                <a href="<?= BASE_URL . ltrim($sub->route, '/') ?>" class="sidebar-link">
                                ...
                                <?php else: ?>
                                    ...
                                    <a class="sidebar-link" href="<?= BASE_URL . ltrim($mod->route ?? '', '/') ?>" aria-expanded="false">
                                        <span><i class="<?= $mod->icon ?>"></i></span>
                                        <span class="hide-menu"><?= htmlspecialchars($mod->name) ?></span>
                                    </a>
                        ...
                        <li class="sidebar-item mt-4 border-top pt-3">
                            <a class="sidebar-link text-danger" href="<?= BASE_URL ?>auth/logout" aria-expanded="false">
